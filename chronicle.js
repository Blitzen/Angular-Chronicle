(function () {
    ...
    function equals(o1, o2) {
        var eq, returnEq, t1 = typeof o1, t2 = typeof o2, length, key, keySet;
        ...
        if (o1 !== o1 && o2 !== o2) {
            return { isEqual: true, unequalVariable: '', stringDiff: false, o1: o1, o2: o2 }; // NaN === NaN
        }
        if (t1 === t2) {
            if (t1 === 'string') {
                if (o1 !== o2) {
            ...
            if (t1 === 'object') {
                if (isArray(o1)) {
                    ...
                    if ((length = o1.length) === o2.length) {
                        returnEq = { isEqual: true, unequalVariable: '', stringDiff: false, o1: o1, o2: o2 };
                        for (key = 0; key < length; key++) {
                            eq = equals(o1[key], o2[key]);
                            if (!eq.isEqual) {
    ...
    angular.module('Chronicle', []).service('Chronicle', ['$rootScope', '$parse',
        function ($rootScope, $parse) {
            ...
            this.record = function record(watchVar, scope, stringHandling, noWatchVars) {
                return new Watch(watchVar, scope, stringHandling, noWatchVars);
            };
            ...
            var Watch = function Watch(watchVar, scope, stringHandling, noWatchVars) {
                ...
                if (isArray(noWatchVars)) {
                    for (var i in noWatchVars) {
                        if (noWatchVars.hasOwnProperty(i)) {
            ...
            Watch.prototype.addToArchive = function addToArchive() {
                var parsedUnequalVariable, shouldBeAdded = false, tooSim;
                ...
                if (this.archive.length) {
                    ...
                    if (!eq.isEqual) {
                        ...
                        parsedUnequalVariable = $parse(this.watchVar + eq.unequalVariable);
                        ...
                        if (this.stringHandling && eq.stringDiff) {
                            ...
                            if (differenceObject.areSimilar) {
                                if (this.archive[this.currArchivePos].parsedUnequalVariable === parsedUnequalVariable) {
                                    ...
                                    tooSim = tooSimilar(differenceObject.differences);
